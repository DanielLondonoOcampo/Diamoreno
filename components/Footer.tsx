  ...
  return (
    <footer className="bg-brand-brown text-white/70">
      <div className="max-w-6xl mx-auto px-5 py-14 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        {/* Social Media */}
        <div>
          <h4 className="font-display text-white text-lg mb-4">Síguenos</h4>
          <div className="flex gap-4">
            <a
              href="https://www.instagram.com/diamoreno_deshidratados?igsh=MXZ6dWxjNmZmcXBjOA=="
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.facebook.com/share/18wnYETFtt/?mibextid=wwXIfr"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/70 hover:text-brand-gold transition-colors duration-200"
              aria-label="Facebook"
            ...
            <a
              href="https://www.tiktok.com/@diamorenodeshidratados?_r=1&_t=ZS-973H0G7x2nN"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/70 hover:text-brand-gold transition-colors duration-200"
              aria-label="TikTok"
